...
class ReturController extends Controller
{
    ...
    {
        $datapenjualan=\App\Datapenjualan::All(); 
        return view('retur.retur',['datapenjualan'=>$datapenjualan]);
    }
    ...
    public function edit($id)
    {
        ...
        $AWALJurnal = 'JRU';
            ...
            $detail      = DB::table('tampil_datapenjualan')->where('no_jual',$decrypted)->get();
            ...
            return view('retur.jual',['jual'=>$detail,'format'=>$format,'no_jual'=>$decrypted,'penjualan'=>$penjualan,'formatj'=>$formatj,'kas'=>$akunkas,'retur'=>$akunretur]);
    }
    ...
    public function simpan(Request $request)
    {
        if (Retur::where('no_retur', $request->no_retur)->exists()) {
            ...
            $tambah_datapenjualan=new \App\Retur;
            $tambah_datapenjualan->no_retur = $request->no_retur;
            $tambah_datapenjualan->tgl_retur = $request->tgl;
            $tambah_datapenjualan->total_retur = $total;
           ...
           //SIMPAN ke table jurnal bagian debet
            ...
            $tambah_jurnaldebet->kredit = $total;
