...
<head>
    ...
    <title>Penjualan Apotek Raja</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Apotek Raja </div>
            </a>
            ...
            @role('admin')
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('barang.index') }}">Data Obat</a>
...
<li class="nav-item">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('penjualan.transaksi') }}"  >
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('datapenjualan.transaksi') }}"  >
                    <i class="fas fa-fw fa-folder"></i>
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <div class="input-group-append">
                                <h4>Sistem Penjualan Apotek Raja</h4>
                            </div>
                        </div>
                    </form>
                    ...
                    <!-- Topbar Navbar -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="rounded-circle" src="{{asset('asset/img/profpic.png')}}" width="43" >
                            </a>
