...
<input id="jenis" type="hidden" name="jenis" value="cetak" class="form-control">
...
<input id="jenis" type="hidden" name="jenis" value="lappenj" class="form-control">
<select id="periode" name="periode"class="form-control">
<option value="">--Pilih Periode Laporan--
</option>
<option value="All">Semua</option>
...
<input id="jenis" type="hidden" name="jenis" value="lapobt" class="form-control">
<select id="periode" name="periode"class="form-control">
<option value="">--Pilih Periode Laporan--
</option>
<option value="All">Semua</option>
