                        ...
                        @foreach ($penjualan as $jual)
                            <tr>
                                ...
                                <td width="30%">
                                    ...
                                    {{-- test fitur detail  --}}
                                    {{-- <a href="{{ route('detailPenjualan', [Crypt::encryptString($jual->no_jual)]) }}"
                                            class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm">
                                            <i class="fas fa-print fa-sm text-white-50"></i> Detail Penjualan</a> --}}
                                    <a href="/akun/hapus/{{ $jual->no_jual }}"
