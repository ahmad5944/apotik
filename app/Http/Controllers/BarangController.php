...
class BarangController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $tambah_barang->jenis = $request->addjenis;
        $tambah_barang->harga = $request->addharga;
        $tambah_barang->stok = $request->addstok;
        $tambah_barang->tgl = $request->addtgl;
        $tambah_barang->save();
        Alert::success('Tersimpan ','Data obat berhasil disimpan');
    ...
    public function update(Request $request, $id)
    {
        ...
        $update_barang->jenis=$request->get('addjenis');
        $update_barang->harga=$request->get('addharga');
        $update_barang->stok=$request->get('addstok');
        $update_barang->tgl=$request->get('addtgl');
        $update_barang->save();
        Alert::success('Update', 'Data Obat Berhasil Diupdate');
    ...
    public function destroy($kd_brg)
    {
        ...
        $barang->delete();
        Alert::success('Terhapus ','Data obat berhasil dihapus');
        return redirect()->route('barang.index');
    }
}