...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-00">Data Obat</h1>
</div>
<hr>
...
<table class="table table-bordered tablestriped" id="dataTable" width="100%" cellspacing="0">
    ...
    <tr>
        ...
        <td>{{ $brg->tgl}}</td>
        <td align="center"><a href="{{route('barang.edit',[$brg->kd_brg])}}"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modaltitle" id="exampleModalScrollableTitle">Tambah Data Obat</h5>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="addkdbrg" id="addkdbrg" class="formcontrol" maxlegth="5" id="exampleFormControlInput1" >
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Nama Obat</label>
                    <input type="text" name="addnmbrg" id="addnmbrg" class="formcontrol" id="exampleFormControlInput1" >
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Jenis Obat</label>
                    <input type="text" name="addjenis" id="addjenis" class="formcontrol" id="exampleFormControlInput1" >
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Harga Obat</label>
                    <input type="number" name="addharga" id="addharga" class="formcontrol" id="exampleFormControlInput1" >
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Stok Obat</label>
                    <input type="number" name="addstok" id="addstok" class="formcontrol" id="exampleFormControlInput1" >
                </div>
                <div class="form-group ">
                    <label for="exampleFormControlInput1">Tanggal kedaluwarsa</label>
                    <input type="date"  name="addtgl" id="addtgl" class="form-control" id="exampleFormControlInput1">
                </div>
            </div>
